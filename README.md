...
### Memulai PHP
<p>Buat folder (Lab2Web-main) pada root direktori web server (C:\xampp\htdocs)
...
<p>Kemudian untuk mengakses hasilnya melalui URL: http://localhost/Lab2Web-main/php_dasar.php
...
### Predefine Variable
<p>Buat file (predefine_variable.php) dalam direktori Lab2Web-main. lalu masukan kode berikut.
...
<p>Untuk mengaksesnya gunakan URL: http://localhost/Lab2Web-main/predefine_variable.php?nama=Difa Hariz Z 

![Predefine Variable](img/predefine_variable.png)

### Membuat Form Input
- Buat file (membuat_form_input.php) didalam direktori Lab2Web-main, Kemudian tambahkan kode berikut.
...
### Operator
- Buat file (operator.php) didalam direktori Lab2Web-main, Kemudian masukan kode berikut.
...
### Kondisi Switch
- Buat file (kondisi_switch.php) didalam direktori Lab2Web-main, Kemudian masukan kode berikut.
...
### Perulangan For
- Buat file (perulangan_for.php) didalam direktori Lab2Web-main, Kemudian masukan kode berikut.
...
### Perulangan While
- Buat file (perulangan_while.php) didalam direktori Lab2Web-main, Kemudian masukan kode berikut.
...
### Perulangan Do While
- Buat file (perulangan_dowhile.php) didalam direktori Lab2Web-main, Kemudian masukan kode berikut.
